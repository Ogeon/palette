...
mod test {
    ...
    mod lut {
        ...
        fn lut_reuse() {
            ...
            let linear = decode_lut.lookup_rgb(rgb::DciP3::new(23, 198, 76));
            let _ = encode_lut.lookup_rgb(linear);

            let linear = decode_lut.lookup_rgb(rgb::DciP3Plus::new(23, 198, 76));
            let _ = encode_lut.lookup_rgb(linear);
        }
    }
}
