...
/// Cartesian CAM16-UCS with an alpha component. See the [`Cam16UcsJaba`
/// implementation in `Alpha`](crate::Alpha#Cam16UcsJaba).
...
mod test {
    ...
    struct_of_arrays_tests!(
        Cam16UcsJab,
        Cam16UcsJab::new(0.1f32, 0.2, 0.3),
        Cam16UcsJab::new(0.2, 0.3, 0.4),
        Cam16UcsJab::new(0.3, 0.4, 0.5)
    );

    mod alpha {
        use crate::cam16::Cam16UcsJaba;

        struct_of_arrays_tests!(
            Cam16UcsJaba,
            Cam16UcsJaba::new(0.1f32, 0.2, 0.3, 0.4),
            Cam16UcsJaba::new(0.2, 0.3, 0.4, 0.5),
            Cam16UcsJaba::new(0.3, 0.4, 0.5, 0.6)
        );
    }
