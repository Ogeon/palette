...
//! # Arrays and Slices
//!
//! Colors that implement [`ArrayCast`] can be cast to and from arrays and
//! slices with little to no overhead. This makes it easy to work with image
//! buffers and types from other crates without having to copy the data first.
//!
//! ## Casting Arrays
//!
