...
fn main() {
    ...
    for i in 0..11 {
        let rgb1= rgb.darken(0.05 * i as f32).to_srgb();
        let rgb2 = rgb.lighten(0.05 * i as f32).to_srgb();
        ...
        let lab1= Rgb::from(lab.darken(0.05 * i as f32)).to_srgb();
        let lab2 = Rgb::from(lab.lighten(0.05 * i as f32)).to_srgb();
        ...
        let hsv1 = Rgb::from(hsv.darken(0.05 * i as f32)).to_srgb();
        let hsv2 = Rgb::from(hsv.lighten(0.05 * i as f32)).to_srgb();
