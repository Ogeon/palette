...
fn blend_color() {
    ...
    let c: LinSrgb = a.blend(b, |a: PreAlpha<LinRgb<_>, _>, b: PreAlpha<LinRgb<_>, _>| a.component_wise(&b, |a, b| a + b)).into();
...
fn blend_alpha_color() {
    ...
    let c: LinSrgba = a.blend(b, |a: PreAlpha<LinRgb<_>, _>, b: PreAlpha<LinRgb<_>, _>| a.component_wise(&b, |a, b| a + b)).into();
