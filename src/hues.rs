...
#[doc =
      r"elementary colors _red_, _yellow_, _green_ and _blue_. This makes it"]
...
#[doc =
      r"A hue type for the RGB family of color spaces."]
#[doc = r""]
#[doc =
      r"It's measured in degrees and uses the three additive primaries _red_,"]
